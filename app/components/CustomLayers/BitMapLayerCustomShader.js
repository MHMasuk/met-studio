...
class BitMapLayerCustomShader extends BitmapLayer {
    getShaders(opts) {
        return {
            ...
            inject: {
                ...
                'fs:DECKGL_FILTER_COLOR': `
                    vec3 value;
                    if (color.r < 0.0) {
                        value = vec3(0.6196078431372549, 0.00392156862745098, 0.25882352941176473);
...
BitMapLayerCustomShader.layerName = 'BitMapLayerCustomShader';

export default BitMapLayerCustomShader;
